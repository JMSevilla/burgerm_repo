        ...
        <el-tab-pane label="Add Suppliers">
          ...
          <el-steps :active="stepsactive">
            <el-step
              ...
              description="Upload a picture of your supplier"
            ></el-step>
            <el-step
              title="Supplier Details"
              description="Provide some details for your supplier"
            ></el-step>
            <el-step
              title="Finish"
          ...
          <div v-if="stepsactive == 0">
            <el-card
              shadow="always"
              style="padding: 20px; margin-top: 20px; margin-bottom: 20px"
            >
          ...
          <div v-else-if="stepsactive == 1">
            ...
            >
              <div>
                ...
                <el-tooltip
                  content="This identification code is for search feature"
                  placement="top"
                >
                  <i class="el-icon-info"></i>
                </el-tooltip>
                <br />
                <label style="margin-top: 10px; font-size: 16px"
              ...
              <div style="margin-top: 20px">
                ...
                <div style="margin-top: 20px">
                  ...
                  <label style="font-size: 16px"
                    >Secondary Address (Optional)</label
                  >
                  <el-input
                    type="textarea"
                    :autosize="{ minRows: 2, maxRows: 4 }"
                ...
                <div style="margin-top: 20px">
                  ...
                  <el-tag type="danger"
                    >Suppliers Contact Details (Required)</el-tag
                  >
                  <div class="row" style="margin-top: 20px">
                    <div class="col-sm">
          ...
          <div v-else-if="stepsactive == 3" style="padding: 25px">
            <el-card shadow="always" style="margin-top: 30px">
              <center>
                <img
                  src="https://cdn2.iconfinder.com/data/icons/scenarium-vol-2-1/128/044_check_ok_done_final-128.png"
                  alt="No image"
                  class="img-fluid"
        ...
        <el-tab-pane label="View suppliers">
          ...
          >
            ...
            <el-button
              ...
              @click="onswitchview()"
              >{{
                dataview ? "Switch to listview" : "Switch to gridview"
              }}</el-button
            >
                  ...
                  <div class="col-sm">
                    ...
                    >
                      <el-tag style="margin-bottom: 20px"
                        >Suppliers identification code :
                        {{ item.supplierIdentificationCode }}</el-tag
                      >
                      <center>
                        <el-avatar
                          shape="square"
                          ...
                          fit="fill"
                          style="margin-bottom: 3px; margin-top: 10px"
                          :src="item.supplierimgurl"
                        ></el-avatar>
                        <h3>
                          {{
                            item.supplierfirstname + " " + item.supplierlastname
                          }}
                        </h3>
                      </center>
                      <hr />
                      ...
                      <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-sm">
                          <span
                            >Contact Number : {{ item.suppliernumber }}</span
                          >
                        </div>
                      </div>
                      <div class="row" style="margin-top: 20px">
                        <div class="col-sm">
                          <span
                            >Address :
                            {{
                              item.supplierprimaryaddress +
                              " " +
                              item.suppliersecondaryaddress
                            }}</span
                          >
                        </div>
                        <div class="col-sm">
                          <span
                            >Created :
                            {{ item.createdAt | moment("calendar") }}</span
                          >
                        </div>
                      </div>
                      ...
                      <el-button
                        @click="onsendemailoutlook(item.supplieremail)"
                        type="warning"
                        style="
                          float: right;
                          margin-bottom: 10px;
                          ...
                          margin-right: 10px;
                        "
                        ><i class="el-icon-message"></i> Send an
                        email</el-button
                      >
                      <el-button
                        @click="onremovesupplier(item.id)"
                        type="danger"
                        style="
                          float: right;
                          margin-bottom: 10px;
                          ...
                          margin-right: 10px;
                        "
                        ><i class="el-icon-delete-solid"></i> Remove</el-button
                      >
                      <el-button
                        @click="
                          onmodifysupplier(
                            item.id,
                            item.supplierfirstname,
                        ...
                        style="
                          ...
                          margin-top: 20px;
                        "
                        ><i class="el-icon-edit"></i> Modify</el-button
                      >
                    </el-card>
                    ...
                    <el-pagination
                      ...
                      :page-size="pageSize"
                      :total="this.suppliersList.length"
                    ...
                    <div v-if="row.isstatus == 0">
                      <el-button
                        ...
                        @click="
                          onmodifysupplier(
                            row.id,
                            row.supplierfirstname,
                            row.supplierlastname,
                            row.supplieremail,
                            row.suppliernumber,
                            row.supplierimgurl
                          )
            ...
            >
              <div class="row">
                    ...
                    <div class="row" style="margin-bottom: 20px">
                      <center>
                        ...
                        <el-progress
                          ...
                          style="margin-bottom: 10px"
                          :stroke-width="26"
                          :percentage="modifyuploadpercent"
                        ></el-progress>
                        <el-button
                          type="primary"
                          style="margin-bottom: 10px"
                          plain
                          @click="modifyonupload()"
                          >Upload now</el-button
                        >
                      </center>
                      <div class="col-sm">
                ...
                <div class="col-sm">
                  <img
                    src="https://cdn.dribbble.com/users/949592/screenshots/4171049/customise.jpg?compress=1&resize=800x600"
                    alt="No image"
                    style="width: 100%; height: auto"
                    class="img-fluid"
                  />
...
export default {
      ...
      if (this.searchable) {
        return this.suppliersList.filter((item) => {
          return this.searchable
            ...
            .every(
              (v) =>
                item.supplierIdentificationCode.toLowerCase().includes(v) ||
                item.supplierfirstname.toLowerCase().includes(v)
            );
        });
      } else {
        return this.suppliersList.slice(
  ...
  methods: {
    onsavemodifysupplier() {
      if (
        !this.modifySupplier.modifyfname ||
        !this.modifySupplier.modifylname ||
        !this.modifySupplier.modifyemail ||
        !this.modifySupplier.modifynumber
      ) {
        this.$notify.warning({
          title: "Oops",
        ...
        this.$confirm(
          "This will update the supplier information. Continue?",
          "Warning",
          {
    ...
    modifyonupload() {
      ...
      const checkstorage = firebase
        .storage()
        .ref(`${this.modifyimgdata.name}`)
        .getDownloadURL()
        .then((resolve) => {
          const ref = firebase
            .storage()
            .ref(`supplier/${this.modifyimgdata.name}`);
        ...
        .catch((err) => {
          const storageRef = firebase
            .storage()
            .ref(`supplier/${this.modifyimgdata.name}`)
            .put(this.modifyimgdata);
          storageRef.on(
            `state_changed`,
            (snapshot) => {
              this.modifyuploadpercent =
    ...
    onremovesupplier(id) {
      this.$confirm(
        "This supplier will be moved on archive. Continue?",
        "Warning",
        {
          confirmButtonText: "OK",
          cancelButtonText: "Cancel",
    ...
    oncall(phone) {
      this.$confirm(
        "This will open another app for you to call. Continue?",
        "Warning",
        {
          confirmButtonText: "OK",
          cancelButtonText: "Cancel",
    ...
    onsendemailoutlook(email) {
      this.$confirm(
        "This will open another app for you to send an email. Continue?",
        "Warning",
        {
          confirmButtonText: "OK",
          cancelButtonText: "Cancel",
    ...
    onnext() {
      if (this.stepsactive === 0) {
        ...
        if (!this.supplierTask.supplierIC) {
          ...
          !this.supplierTask.supplierfirstname ||
          !this.supplierTask.supplierlastname
        ) {
          this.$notify.warning({
            title: "Uh oh",
          ...
          !this.supplierTask.suppliernumber ||
          !this.supplierTask.supplieremail
        ) {
          this.$notify.warning({
            title: "Uh oh",
    ...
    onupload() {
      ...
      const checkstorage = firebase
        ...
        .catch((err) => {
          const storageRef = firebase
            .storage()
            .ref(`supplier/${this.imgdata.name}`)
            .put(this.imgdata);
          storageRef.on(
            `state_changed`,
            (snapshot) => {
